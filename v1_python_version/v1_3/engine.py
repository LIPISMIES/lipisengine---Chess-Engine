...
def alphabeta(board, remaining_depth, initial_depth, alpha, beta, maximizing):
    key = chess.polyglot.zobrist_hash(board)  # Hyvä valinta: python-chess tarjoaa tämän

    # 🔁 Tarkista transpositiotaulu – käytetään vain, jos tallennettu syvyys >= nykyinen
    ...
    # 🎯 Lehtisolmun tai pelin päättymisen käsittely
...
def find_best_move(board, depth=DEFAULT_DEPTH):
    ...
    return alphabeta(board, depth, depth, -inf, inf, maximizing)
