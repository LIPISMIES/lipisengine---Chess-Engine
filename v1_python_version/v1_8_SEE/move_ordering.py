...
def order_moves(board, context, current_depth, last_move=None):
    ...
    def move_score(move):
        ...
        if is_quiet:
            ...
            score += 0.2 * context.history_heuristic.get(key, 0) / (context.max_history_score.get(key, 1) + 1e-5)
        ...
        if board.is_capture(move):
            ...
            if attacker and victim:
                ...
                score += 0.4 * context.capture_history.get(key, 0) / (context.max_capture_history_score.get(key, 1) + 1e-5)
