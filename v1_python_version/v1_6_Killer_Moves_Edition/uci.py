# uci.py
# LipisEngine 1.6 Killer Moves Edition
import chess
...
def uci_loop():
    while True:
        ...
        if line == "uci":
            print("id name LipisEngine 1.6 Killer Moves Edition")
            print("id author Jaakko Simonen 'LIPISMIES'")
            print("uciok")
        ...
        # go-komento etsii parhaan siirron
            ...
            eval_score, pv = find_best_move(board, depth)
            ...
            if abs(eval_score) >= MATE_SCORE - depth:
                ...
                print(f"info depth {depth} score cp {cp} pv {' '.join(move.uci() for move in pv)}")
